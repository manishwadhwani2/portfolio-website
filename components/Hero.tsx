  ...
  return (
    <Section id="about" className="min-h-screen flex flex-col justify-center pt-24">
      <div className="max-w-4xl space-y-6">
        ...
        <p className="text-lg text-slate-400 max-w-2xl leading-relaxed pt-4">
          {PERSONAL_INFO.about}
        </p>
        ...
        <div className="flex flex-wrap gap-4 pt-8">
          <a 
            ...
            target="_blank" 
            rel="noreferrer"
            className="px-6 py-3 rounded-md bg-slate-800 text-white font-medium hover:bg-slate-700 transition-colors flex items-center gap-2"
          >
          ...
          <a 
            ...
            target="_blank" 
            rel="noreferrer"
            className="px-6 py-3 rounded-md border border-primary-500 text-primary-400 font-medium hover:bg-primary-500/10 transition-colors flex items-center gap-2"
          >
